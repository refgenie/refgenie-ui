        ...
        <div className='row page-width sticky-top'>
          <div className='col-12 p-4'>
            ...
            <div className='col-12 text-start'>
              ...
              <p className='fst-condensed mt-3 mb-0'>Browse</p>
              <div className=''>
                <NavLink
                  page={'genomes'}
                  title={'Genomes'}
              ...
              <div className=''>
                <a
                  className='text-decoration-none cursor-pointer text-black-50 nav-hover ps-2 rounded-2 d-flex align-items-center'
                  href='https://api.refgenie.org/docs'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  <p className='fst-condensed mb-0 cursor-pointer text-black-50 fw-lighter'>
                    API
                  </p>
                  <i className='ms-auto me-2 bi bi-box-arrow-up-right text-xs'></i>
                </a>
                <a
                  className='text-decoration-none cursor-pointer text-black-50 nav-hover ps-2 rounded-2 d-flex align-items-center'
                  href='https://refgenie.org'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  <p className='fst-condensed mb-0 cursor-pointer text-black-50 fw-lighter'>
                ...
                <a
                  className='text-decoration-none cursor-pointer text-black-50 nav-hover ps-2 rounded-2 d-flex align-items-center'
                  href='https://github.com/refgenie/refgenie'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  <p className='fst-condensed mb-0 cursor-pointer text-black-50 fw-lighter'>
